...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37414_SHARP_){
return html_coll.item(p1__37414_SHARP_);
...
return cljs.core.some((function (p1__37418_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("icon",p1__37418_SHARP_);
...
var ctx_37484 = cvs.getContext("2d");
(ctx_37484.fillStyle = color);

ctx_37484.fillRect((0),(0),size,size);
