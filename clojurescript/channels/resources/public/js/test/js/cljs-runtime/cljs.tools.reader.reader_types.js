...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_27409 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_27409(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_27413 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_27413(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_27437 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_27437(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_27441 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_27441(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_27442 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_27442(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_27447 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_27447(reader);
}
});
...
var G__27559 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__27560 = s.append(c);
c = G__27559;
s = G__27560;
continue;
}
