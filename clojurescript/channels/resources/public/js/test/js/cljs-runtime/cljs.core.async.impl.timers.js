...
var i_29859 = (0);
while(true){
if((i_29859 < arr.length)){
(arr[i_29859] = null);

var G__29860 = (i_29859 + (1));
i_29859 = G__29860;
continue;
} else {
}
...
var i_29891 = (self__.level + (1));
while(true){
if((i_29891 <= (new_level + (1)))){
(update[i_29891] = self__.header);

var G__29894 = (i_29891 + (1));
i_29891 = G__29894;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_29896 = (update[i]).forward;
(x__$2.forward[i] = (links_29896[i]));
...
var i_29903 = (0);
while(true){
if((i_29903 <= self__.level)){
var links_29904 = (update[i_29903]).forward;
if((x__$1 === (((i_29903 < links_29904.length))?(links_29904[i_29903]):null))){
(links_29904[i_29903] = (x__$1.forward[i_29903]));

var G__29912 = (i_29903 + (1));
i_29903 = G__29912;
continue;
} else {
var G__29915 = (i_29903 + (1));
i_29903 = G__29915;
continue;
}
} else {
